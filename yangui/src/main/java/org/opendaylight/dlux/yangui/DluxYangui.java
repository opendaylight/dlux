package org.opendaylight.dlux.yangui;
/**
...
public class DluxYangui {
    ...
    public void registerCore() throws NamespaceException{
        if(httpService != null) {
            ...
            httpService.registerResources("/yangui", "/yangui", null);
        } else {
            //logger.error("httpService is null. Cannot register resources");
        }
        if (httpService != null && bootstrapper != null) {
            bootstrapper.addModule("yangui", "/yangui", "yangui", "console.yangui");
        } else {
