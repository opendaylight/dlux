package org.opendaylight.dlux.node;
/**
...
public class DluxNode {
    ...
    public void readConfig() {
        ...
        try {
            ...
            input = DluxNode.class.getClassLoader().getResourceAsStream(filename);
            if(input==null){
