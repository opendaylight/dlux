...
public class DluxHome {
    ...
    final static Logger logger = LoggerFactory.getLogger(DluxHome.class);
    ...
    public void registerCore() throws NamespaceException{
        if(httpService != null) {
            logger.info("Registering resources for home");
        ...
        if (httpService != null && bootstrapper != null) {
            ...
            logger.error("bootstrapper is null. Cannot add home module to bootstrapper");
        }
    }
}
