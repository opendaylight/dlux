package org.opendaylight.dlux.common.topbar;
/**
...
public class DluxTopbar {
    HttpService httpService;
    IDluxBootstrapperRegistration bootstrapper;
    //final static Logger logger = LoggerFactory.getLogger(DluxCore.class);

    // Module Information
    String moduleName = "topbar";
    String url = "/topbar";
    String directory = "/topbar";
    String requireJs = "topbar.module";
    String angularJs = "app.common.topbar";
    ...
    public void readConfig() {
        ...
        try {
            ...
            input = DluxTopbar.class.getClassLoader().getResourceAsStream(filename);
            if(input==null){
