package org.opendaylight.dlux.container;
/**
...
public class DluxContainer {
    ...
    public void registerCore() throws NamespaceException{
        if(httpService != null) {
            ...
            httpService.registerResources("/container", "/container", null);
        } else {
            //logger.error("httpService is null. Cannot register resources");
        }
        if (httpService != null && bootstrapper != null) {
            bootstrapper.addModule("container", "/container", "container", "console.container");
        } else {
