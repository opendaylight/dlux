package org.opendaylight.dlux.general;
/**
...
public class DluxGeneral {
    ...
    String requireJs = "common.general.module";
    String angularJs = "app.common.general";
    ...
    public void readConfig() {
        ...
        try {
            ...
            input = DluxGeneral.class.getClassLoader().getResourceAsStream(filename);
            if(input==null){
