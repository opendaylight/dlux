define(['common/yangutils/yangutils.module'], function(yangUtils) {
  ...
  // In the yangui.module.js, this file is loader immediatly after 
  // his module. So we don't need to register the services. 
  ...
  yangUtils.factory('nodeWrapper', function () {
  ...
  yangUtils.factory('yinParser', function ($http, $timeout) {
  ...
  yangUtils.factory('yangUtils', function ($http, yinParser, nodeWrapper, reqBuilder) {
