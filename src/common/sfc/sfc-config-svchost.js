(function () {
  ...
  module.factory("SfcConfigSvc", function (SfcJsonValidationSvc, ServiceFunctionSvc, ServiceNodeSvc, ServiceChainSvc, sfcFormatMessage) {
  ...
  module.factory("SfcConfigExportSvc", function($q, ServiceFunctionSvc, ServiceNodeSvc, ServiceChainSvc) {
