(function () {
  ...
  module.factory("SfcConfigSvc", function (SfcJsonValidationSvc, ServiceFunctionSvc, ServiceNodeSvc, ServiceChainSvc) {
...
//        var schemaUri = error.schemaUri;
        ...
        throw new Error(format("json does not validate to schema: \n{0}\n\npath: {1}\n\nmessage: {2}{3}", dataObject, errorPath, message, detail ? "\n\ndetail: " + detail : ''));
      }
    };
