define(['angularAMD', 'Restangular', 'common/general/finishRender.module', 'app/core/core.services', 'common/filter/common.filters.module'], function (ng) {
  var flows = angular.module('app.flows', ['ui.router.state', 'app.core', 'restangular', 'app.common.finishRender','app.common.filters']);

  flows.config(function($controllerProvider, $compileProvider, $provide, $stateProvider, NavHelperProvider) {
    flows.register = {
