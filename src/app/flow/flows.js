angular.module('console.flow', ['common.finishRender'])

.controller('FlowCreateCtrl', function ($scope, $http, FlowSvc, SwitchSvc, $state) {
  // The current flow
...
.controller('FlowCompositionCtrl', function ($scope, $state) {
...
.config(function ($stateProvider) {
  ...
  $stateProvider.state('flow.detail', {
    ...
    views: {
      '': {
        ...
        controller: ['$scope', 'FlowSvc', '$stateParams', function ($scope, FlowSvc, $stateParams) {
  ...
  $stateProvider.state('flow.edit', {
    url: '/:nodeType/:nodeId/:flowName/edit',
    access: access.public,
    views: {
      '': {
        templateUrl: 'flow/edit.tpl.html',
        controller: ['$scope', 'FlowSvc', '$stateParams', 'SwitchSvc', function ($scope, FlowSvc, $stateParams, SwitchSvc) {
