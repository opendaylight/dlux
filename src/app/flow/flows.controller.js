define(['app/flow/flows.module', 'jquery', 'footable', 'app/flow/flows.services', 'common/filter/common.filters'], function(flows, $) {
   
  flows.register.controller('rootFlowCtrl', function($rootScope) {
