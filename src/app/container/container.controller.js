define(['app/container/container.module', 'jquery', 'footable', 'app/container/container.services'], function(container, $) {

  container.register.controller('rootContainerCtrl', ['$rootScope', function($rootScope) {
