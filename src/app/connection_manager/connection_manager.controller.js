define (['app/connection_manager/connection_manager.module', 'app/connection_manager/connection_manager.services'], function(connection_manager) {
  ...
  connection_manager.register.controller('ConnectionManagerDiscoveryCtrl', ['$scope', 'SwitchSvc', 'ConnectionManagerSvc', '$state', function ($scope, SwitchSvc, ConnectionManagerSvc, $state) {
    $scope.nodePort = 6633;
