define(['app/sfc/sfc.module'], function (sfc) {
  ...
  // FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
  // FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
  sfc.register.factory("SfcJsonValidationSvc", function (SfcSchemaStoreSvc, JsvLoaderSvc) {
    ...
    var sfcValidate = function (instanceJSON, type, revision) {
      ...
      if (!env) {
        // create new JSV environment and populate typy to URI map
      ...
      if (!uriForType) {
        throw new Error("No validation schema URI for type defined!");
      }
  ...
  sfc.register.factory("JsvLoaderSvc", function ($q, sfcRegisterSchemas2014_07_01) {

    var dummy = sfcRegisterSchemas2014_07_01; // register shemas
    ...
    var loadValidator = function () {
      ...
      if (!validator) {
        ...
        // load only once
        require(['./assets/js/jsv/uri.js'], function () {
          require(['./assets/js/jsv/urn.js'], function () {
            require(['./assets/js/jsv/jsv.js'], function () {
              require([/*'assets/js/jsv/json-schema-draft-01', 'assets/js/jsv/json-schema-draft-02',*/ './assets/js/jsv/json-schema-draft-03.js'], function () {
