define(['app/sfc/sfc.global', 'common/layout/layout.module', 'angular-ui-router', 'app/core/core.module', 'common/navigation/navigation.module'], function (sfc) {
  ...
  ddescribe('SFC app', function () {
    ...
    var serviceFunctionSvcMock, serviceNodeSvcMock, modalDeleteSvcMock, serviceNodeCtrlFuncMock;
    var exampleData = {};
        ...
        beforeEach(angular.mock.inject(function ($controller) {
          createServiceNodeCtrl = function () {
            return $controller('serviceNodeCtrl', {$scope: scope, $state: state,
              ...
              ServiceNodeCtrlFunc: serviceNodeCtrlFuncMock, ModalDeleteSvc: modalDeleteSvcMock});
          };
        }));
