define(['app/sfc/sfc.global', 'common/layout/layout.module', 'angular-ui-router', 'app/core/core.module', 'common/navigation/navigation.module'], function (sfc) {
  ...
  ddescribe('SFC app', function () {
    ...
    var serviceFunctionSvcMock, serviceNodeSvcMock, modalDeleteSvcMock, serviceNodeTopologyBackendMock;
    var exampleData = {};
    ...
    describe('servicenode.controller', function () {
      ...
      describe('serviceNodeCtrl', function () {
        ...
        it("should call createGraphData", function () {
          ...
          createServiceNodeCtrl();
          expect(serviceNodeTopologyBackendMock.createGraphData).toHaveBeenCalledWith(exampleData.sns, exampleData.sfs);
        ...
        it("should open modal dialog, delete service node, refresh Service Nodes and call createGraphData ", function () {
          ...
          expect(serviceNodeTopologyBackendMock.createGraphData).toHaveBeenCalledWith([], exampleData.sfs);
