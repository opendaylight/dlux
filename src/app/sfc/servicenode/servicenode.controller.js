define(['app/sfc/sfc.module'], function (sfc) {
  ...
  sfc.controller('serviceNodeCtrl', function ($scope, $state, ServiceFunctionSvc, ServiceNodeSvc, ServiceNodeTopologyBackend, ModalDeleteSvc) {
        ...
        if (result == 'delete') {
          ServiceNodeSvc.deleteItem({name: snName}, function () {
            ...
            ServiceNodeSvc.getArray(function (data) {
              $scope.sns = data;
              $scope.snsGraph = ServiceNodeTopologyBackend.createGraphData($scope.sns, $scope.sfs);
            });
          });
        }
      });
