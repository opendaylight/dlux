define(['app/sfc/sfc.module'], function (sfc) {
  ...
  sfc.register.factory('SfcRpcError', function (sfcFormatMessage) {
  ...
  sfc.register.factory('SfcRestangularSvc', function (Restangular) {
    ...
    svc.newBaseUrl = "http://localhost:8080/restconf";
...
// ******* SfcRestBaseSvc *********
  sfc.register.factory('SfcRestBaseSvc', function (SfcRestangularSvc, SfcRpcError) {
