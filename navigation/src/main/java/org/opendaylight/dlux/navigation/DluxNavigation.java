package org.opendaylight.dlux.navigation;
/**
...
public class DluxNavigation {
    HttpService httpService;
    IDluxBootstrapperRegistration bootstrapper;
    //final static Logger logger = LoggerFactory.getLogger(DluxCore.class);

    // Module Information
    String moduleName = "navigation";
    String url = "/navigation";
    String directory = "/navigation";
    String requireJs = "navigation.module";
    String angularJs = "app.common.nav";
    ...
    public void readConfig() {
        ...
        try {
            ...
            input = DluxNavigation.class.getClassLoader().getResourceAsStream(filename);
            if(input==null){
