define(['app/eline/eline.module', 'app/eline/eline.services'], function(eline) {
        ...
        function ($scope, $rootScope, $http, $timeout, Restangular, ElineSvc, ElineUtils) {
            ...
            var addEline = function(id, data) {
                ...
                if($scope.provisionedElines.hasOwnProperty(id) === false) {
                    ...
                    $scope.provisionedElines[id].status = data.status;
                }
            };
            ...
            $scope.load = function(){
                ...
                // console.log(ElineUtils.convertHexToBase64('0x00-0x06-0x50-0x17-0xff-0x5b-0xae-0x80'));//0x00-0x04-0x00-0x05-0x01-0x05
                // console.log(ElineUtils.convertHexToBase64('0x00-0x04-0x00-0x05-0x01-0x05'));//0x00-0x04-0x00-0x05-0x01-0x05
    ...
    eline.register.controller('ridcidCtrl', ['$scope','ElineUtils',
        function ($scope, ElineUtils) {
            ...
            var change = function() {
                var obj = {'remote-id': ElineUtils.convertHexToBase64($scope.rid), 'circuit-id': ElineUtils.convertHexToBase64($scope.cid) };
                $scope.setValue(obj, $scope.pdIndex);
            };
