...
define(['app/yangui/yangui.test.module.loader', 'common/layout/layout.module'], function () {
    ...
    describe('yangui', function () {
        ...
        beforeEach(angular.mock.inject(
            function (_YangConfigRestangular_, _yangUtils_, _nodeWrapper_, _reqBuilder_, _apiConnector_, _yinParser_,
                     _constants_) {
        ...
        describe('ListCtrl', function () {
            ...
            beforeEach(angular.mock.inject( function ($controller, $rootScope, _constants_ ) {
                ...
                yinParser.__test.yangParser.createNewNode(
                    'REALLYREALLYLONGNAMEFORLEAFTHATISINKEY',
                    'leaf',
                    node,
                    _constants_.NODE_UI_DISPLAY
                );
                yinParser.__test.yangParser.createNewNode(
                    'REALLYREALLYLONGNAMEFORLEAFTHATISINKEY',
                    'key',
                    node,
                    _constants_.NODE_ALTER
                );
                nodeWrapper.wrapAll(node);
                $scope.node = node;
                $scope.preview = function () {
            ...
            it('getListName', function () {
                ...
                var createResult = $scope.getListName(0, false),
                    expectedName = ' <' +
                        $scope.node.actElemStructure.children[0].label +
                        ':' +
        ...
        describe('YanguiCtrl', function () {
            ...
            beforeEach(angular.mock.inject( function (
                $controller, $rootScope, _$timeout_, _$http_, _$httpBackend_,
                _YangConfigRestangular_, _pathUtils_, _constants_, _custFunct_
            ) {
                $scope = $rootScope.$new();
                ...
                yangUtils.generateNodesToApis = function (success, error) {
                    ...
                    var leaf = yinParser.__test.yangParser.createNewNode(
                        'LEAF',
                        'leaf',
                        null,
                        constants.NODE_UI_DISPLAY
                    );
