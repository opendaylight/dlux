define(['app/yangui/yangui.module', 'common/yangutils/constants'], function(yangui, constants) {
    ...
    yangui.register.service('HistoryService', ['PathUtilsService','YangUtilsService', '$filter', 'EventDispatcherService', 'ParsingJsonService',
        function(PathUtilsService, YangUtilsService, $filter, EventDispatcherService, ParsingJsonService){
