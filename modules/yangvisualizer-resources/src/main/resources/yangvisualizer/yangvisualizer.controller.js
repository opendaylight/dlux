define(['app/yangvisualizer/yangvisualizer.module', 'app/yangvisualizer/yangvisualizer.services', 'app/yangvisualizer/sigma.directive'], function(yangvisualizer) {
    ...
    function ($scope, $rootScope, $http, Restangular, yangUtils, visualizerUtils) {
      ...
      var expandNodeFunc = function(expandNode, mlts){
        ...
        expandNode.node.children.forEach(function(child){
          ...
          // console.log('child.graphId',child.graphId);
      ...
      $scope.topologyCustfunc = function(sigmaIstance, getSlowDownNum){
        ...
        sigmaIstance.bind('outNode', function(e){
          var node = e.data.node;
          // console.log('node.labelToShow', node.labelToShow);
          if ( node.labelToShow !== null ) {
      ...
      $scope.setColorScheme = function(e,property){
        ...
        console.log('$scope.currentTopologyNode', $scope.currentTopologyNode);
        console.log('property', property);
        console.log('$scope.sigma.graph.nodes()',$scope.sigma.graph.nodes());
