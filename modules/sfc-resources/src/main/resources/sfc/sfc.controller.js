...
define([].concat(modules).concat(services).concat(directives).concat(controllers), function (sfc) {
  ...
  sfc.register.controller('rootSfcCtrl', ['$rootScope', 'SfcRestangularSvc', '$sessionStorage', '$location', 'yangUtilsSfc', 'ENV', 'sfcYangParseSvc',
    function ($rootScope, SfcRestangularSvc, $sessionStorage, $location, yangUtils, ENV, sfcYangParseSvc) {
