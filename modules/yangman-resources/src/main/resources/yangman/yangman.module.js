define([
    ...
    function YangManConfig($stateProvider, $compileProvider, $controllerProvider, $mdThemingProvider, $provide,
                           $filterProvider, $translateProvider, $translatePartialLoaderProvider,  NavHelperProvider) {
