define([
    ...
    RequestsListCtrl.$inject = ['$filter', '$mdDialog', '$rootScope', '$scope', '$translate', 'HandleFileService',
        'PathUtilsService', 'RequestsService'];

    function RequestsListCtrl($filter, $mdDialog, $rootScope, $scope, $translate, HandleFileService, PathUtilsService,
                              RequestsService) {
        var vm = this;
