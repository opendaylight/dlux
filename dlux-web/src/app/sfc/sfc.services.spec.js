define(['angularAMD', 'app/sfc/sfc.global'], function () {


  ddescribe("Test Sfc Restangular Services", function () {
    ...
    describe("Test SfcRestBaseSvc", function () {
      ...
      it("executeRpcOperation - should receive RPCError as arg to callback", angular.mock.inject(function (SfcRpcError) {
        ...
        testRestBaseSvc.executeRpcOperation(testObject, "testrpc", testParams, function (arg) {
          expect(arg instanceof SfcRpcError).toBeTruthy();
      ...
      it("extractDataFromRestangular - should return object with only 'containerName' property from input", angular.mock.inject(function () {
        ...
        expect(testRestBaseSvc.extractDataFromRestangular(input)).toEqual(expectContainerObj);
      }));
      ...
      it("checkRequired   - should trow if name property is undefined or empty", angular.mock.inject(function () {
        ...
        }).toThrow("name is undefined or empty");
      }));
    ...
    describe("Test ServiceChainSvc", function () {
      ...
      it("test createInstance function", angular.mock.inject(function () {
        ...
        var expected = {
          "service-function": [{"name": "sf1"}, {"name": "sf2"}],
          "name": "sfc-1"
        };
    ...
    describe("Test sfcFormatMessage", function () {
      ...
      it("check correrct ServicePathSvc instantiation", angular.mock.inject(function () {
        ...
        expect(sfcFormatMessage("{0}", function abc(xyz){console.log(xyz);})).toEqual("function abc(xyz){console.log(xyz);}");
