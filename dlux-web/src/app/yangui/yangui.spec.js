...
define(['app/yangui/yangui.test.module.loader', 'common/layout/layout.module'], function() {
  describe( 'yangui', function() {
      ...
      beforeEach( angular.mock.inject(function(_yinParser_, _nodeWrapper_, _constants_) {
      ...
      /*describe( 'caseCtrl', function() {
          ...
          beforeEach( inject( function($rootScope ) {
              ...
              node = yinParser.__test.yangParser.createNewNode('write-metadata-case', 'case', null, constants.NODE_UI_DISPLAY);
              nodeWrapper.wrapAll(node);
