define(['app/yangui/yangui.module', 'app/yangui/yangui.services', 'app/yangui/abn_tree.directive', 'app/yangui/sticky.directive'], function(yangui) {
  ...
  yangui.register.controller('yanguiCtrl', ['$scope', '$rootScope', '$http', '$timeout', 'YangConfigRestangular', 'yangUtils', 'constants', 'reqBuilder', 'apiConnector', 'NetworkTopologySvc',
    function ($scope, $rootScope, $http, $timeout, Restangular, yangUtils, constants, reqBuilder, apiConnector, NetworkTopologySvc) {
      ...
      var loadNodes = function loadNodes() {
          $scope.devices = [];
          Restangular.one('restconf').all('operational').all('opendaylight-inventory:nodes').getList().then(function(inventoryRawData) {
      ...
      $scope.setApiNode = function(branch) {
          ...
          /*var arrayObjectIndexOf = function(myArray, searchTermArray, property) {

              var searchResultArray = searchTermArray.map(function(searchTerm){
              ...
              return searchResultArray.indexOf(false) > -1 || myArray.length !== searchTermArray.length ? false : true;
          ...
          if( branch.indexApi !== undefined && branch.indexSubApi !== undefined ) {
              ...
              /*if ( arrayObjectIndexOf($scope.selSubApi.pathArray,['config','nodes','node','table','flow'], 'name') ) {
                  //TODO pokracovat - zobrazit button a jeho action ... atd
              }*/
  ...
  yangui.register.controller('listCtrl', function ($scope) {
      ...
      $scope.getData = function getData() {
          console.info($scope.node.listData);
      };
