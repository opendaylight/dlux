define(['common/yangutils/yangutils.module'], function(yangUtils) {
    ...
    // yangUtils.factory('YangConfigRestangular', function(Restangular) {
    //   return Restangular.withConfig(function(RestangularConfig) {
    //     RestangularConfig.setBaseUrl('http://localhost:8080');
    //   });
    // });

    // yangUtils.factory('YangUiRestangular', function( YangConfigRestangular) {
    //   return YangConfigRestangular.one('restconf');
    // });
      ...
      var checkListElemKeys = function(listData, refKey) {
        ...
        var wrapper = {
            ...
            list: function(node) {
                ...
                node.removeListElem = function(elem) {
                    node.listData.splice(node.listData.indexOf(elem), 1);
    ...
    yangUtils.factory('yangUtils', function ($http, yinParser, nodeWrapper, reqBuilder, syncFact, apiConnector, constants, pathUtils) {
        ...
        utils.generateNodesToApis = function(callback, errorCbk, Restangular) {
            var allRootNodes = [],
                apiModules = [],
            ...
            $http.get(Restangular.configuration.baseUrl+'/apidoc/apis/').success(function (data) {
            ...
            $http.get(Restangular.configuration.baseUrl+'/restconf/modules/').success(function (data) {
